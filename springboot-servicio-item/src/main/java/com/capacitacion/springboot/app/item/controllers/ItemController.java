package com.capacitacion.springboot.app.item.controllers;
...
public class ItemController {
	...
	/**
	 * Hystrix se encarga de la tolerancia a fallos 
	 * @param id
	 * @param cantidad
	 * @return
	 */
	...
	/**
	 * Metodo llamado por Hystrix en el caso de falla
	 * @param id
	 * @param cantidad
	 * @return Item
	 */
	...
	public ResponseEntity<?> obtenerConfig(@Value("${server.port}") String puerto){
		...
		if(env.getActiveProfiles().length > 0 && env.getActiveProfiles()[0].equals("desarrollo")) {
			json.put("desarrollador.nombre", env.getProperty("configuracion.desarrollador.nombre"));
